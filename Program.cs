...
{
    public const string GitHubRepo = "https://github.com/JohnMarsing/Blog";
    public const string X = "https:/JohnMarsing/x.com/";
    public const string Title = "John Marsing Blog";
